...
const UserSelection = () => {
  const [selectedType, setSelectedType] = useState<"psychologist" | "patient" | null>(null);
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="space-y-4 mb-16">
          <Button
            variant={selectedType === "psychologist" ? "selection-psychologist" : "outline"}
          ...
          <Button
            variant={selectedType === "patient" ? "selection-patient" : "outline"}
            className="w-full h-14 text-left justify-start"
