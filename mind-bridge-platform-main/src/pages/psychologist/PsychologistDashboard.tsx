...
import { ChevronLeft, ChevronRight, Plus, Users, Calendar, BarChart3, User } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-background pt-12 pb-6 px-6">
        ...
        <Card className="p-4 bg-primary/10">
          ...
          <div className="text-center mb-4">
            <h3 className="text-lg font-bold text-foreground">{months[currentDate.getMonth()]} {currentDate.getFullYear()}</h3>
          </div>
      ...
      <div className="px-6 space-y-6 pb-24">
        {/* My Patients */}
        <Card className="p-4 cursor-pointer" onClick={() => navigate('/psychologist/patients')}>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Pacientes com agendas ativas</p>
            </div>
            <Button 
              size="icon" 
